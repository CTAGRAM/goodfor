...
const OPTIONS = ["18-24", "25-34", "35-44", "45-54", "55-64", "65+"];
...
export default function QuestionAge() {
    ...
    const handleSelect = async (option) => {
        setSelected(option);
        try { await AsyncStorage.setItem("onboarding_user_age_group", option); } catch (e) { console.error(e); }
        setTimeout(() => { router.push("/onboarding/question-gender"); }, 300);
    };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#f2f5f3" }}>
            ...
            {/* Decorative Blurs */}
            <View style={{ position: "absolute", top: -128, left: -80, width: 256, height: 256, backgroundColor: "rgba(214, 228, 218, 0.3)", borderRadius: 128, opacity: 0.6 }} />
            <View style={{ position: "absolute", bottom: 100, right: -60, width: 192, height: 192, backgroundColor: "rgba(52, 168, 83, 0.06)", borderRadius: 96 }} />
            ...
            <View style={{ paddingHorizontal: 24, marginTop: 28, marginBottom: 24 }}>
                ...
                <Text style={{ marginTop: 8, fontSize: 14, color: "#6c7570", lineHeight: 22, fontFamily: "Rubik_400Regular" }}>
                    This helps us tailor safety recommendations.
                </Text>
            </View>
