...
const OPTIONS = ["Mostly", "No, but I've heard the term", "I have no idea"];

export default function QuestionProcessed() {
    ...
    const handleSelect = async (option) => {
        setSelected(option);
        try { await AsyncStorage.setItem("onboarding_processed_knowledge", option); } catch (e) { console.error(e); }
        setTimeout(() => { router.push("/onboarding/question-habits"); }, 300);
    };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#f2f5f3" }}>
            ...
            <View style={{ position: "absolute", top: -60, left: -100, width: 256, height: 256, backgroundColor: "rgba(214, 228, 218, 0.3)", borderRadius: 128, opacity: 0.6 }} />
            <View style={{ position: "absolute", bottom: 120, right: -80, width: 200, height: 200, backgroundColor: "rgba(52, 168, 83, 0.06)", borderRadius: 100 }} />
                ...
                {OPTIONS.map((option) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Text style={{ fontSize: 16, fontFamily: isSelected ? "Rubik_700Bold" : "Rubik_500Medium", color: isSelected ? "#243628" : "#1a1d1c", flex: 1 }}>
                                {option}
                            </Text>
                        </Pressable>
                    );
