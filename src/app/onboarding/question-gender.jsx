...
export default function QuestionGender() {
    ...
    const handleSelect = async (option) => {
        setSelected(option);
        try { await AsyncStorage.setItem("onboarding_user_gender", option); } catch (e) { console.error(e); }
        setTimeout(() => { router.push("/onboarding/question-diet"); }, 300);
    };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#f2f5f3" }}>
            ...
            <View style={{ position: "absolute", top: -100, right: -40, width: 220, height: 220, backgroundColor: "rgba(214, 228, 218, 0.3)", borderRadius: 110, opacity: 0.6 }} />
            <View style={{ position: "absolute", bottom: 180, left: -80, width: 192, height: 192, backgroundColor: "rgba(52, 168, 83, 0.06)", borderRadius: 96 }} />
            ...
            <View style={{ paddingHorizontal: 24, marginTop: 28, marginBottom: 24 }}>
                ...
                <Text style={{ marginTop: 8, fontSize: 14, color: "#6c7570", lineHeight: 22, fontFamily: "Rubik_400Regular" }}>
                    Some ingredients affect genders differently.
                </Text>
            </View>
